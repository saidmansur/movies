...
const Show = () => {
    ...
    const similar = async () => {
        ...
        const similars = await axios({
            method: "get",
            params: param,
            url: "https://api.themoviedb.org/3/movie/" + id + "/similar?api_key=3cc05ada7e70628b8d1bf36e4d1f6fd7&language=ru-RU&page=1",
            config: {
                headers: {
                    "Content-type": "multipart/form-data"
                }
    ...
    const recomindations = async () => {
        ...
        const recomendate = await axios({
            method: "get",
            params: param,
            url: "https://api.themoviedb.org/3/movie/" + id + "/recommendations?api_key=3cc05ada7e70628b8d1bf36e4d1f6fd7&language=ru-RU&page=1",
            config: {
                headers: {
                    "Content-type": "multipart/form-data"
                }
