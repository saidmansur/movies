...
const Sshow = () => {
    ...
    const watch = async () => {
        ...
        const watchs = await axios({
            method: "get",
            params: param,
            url: "https://api.themoviedb.org/3/tv/"+id+"/videos?api_key=3cc05ada7e70628b8d1bf36e4d1f6fd7&language=en-US",
            config: {
                headers: {
                    "Content-type": "multipart/form-data"
                }
    ...
    const similar = async () => {
        ...
        const similars = await axios({
            method: "get",
            params: param,
            url: "https://api.themoviedb.org/3/tv/"+id+"/similar?api_key=3cc05ada7e70628b8d1bf36e4d1f6fd7&language=en-US&page=1",
            config: {
                headers: {
                    "Content-type": "multipart/form-data"
                }
    ...
    const recomindations = async () => {
        ...
        const recomendate = await axios({
            method: "get",
            params: param,
            url: "https://api.themoviedb.org/3/tv/"+id+"/recommendations?api_key=3cc05ada7e70628b8d1bf36e4d1f6fd7&language=ru-RU&page=1",
            config: {
                headers: {
                    "Content-type": "multipart/form-data"
                }
            ...
            <div className="col-12 mt-5">
                <div className="row">
                    <div className="col-3 text-dark">
                        <img src={"https://www.themoviedb.org/t/p/w600_and_h900_bestv2" + backdrop_path}
                            width="300px"
                            height="300px"
                        />
                        <p><b>{name}</b></p>
                                    ...
                                    <>
                                        <div className="row mt-3">
                                            <div className="col-12 d-flex justify-content-center">
                                                <iframe width="800px" height="700px" src={"https://www.youtube.com/embed/" + i.key} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </>
                                )}
